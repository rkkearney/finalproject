...
void winScreen()
{
	...
	gfx_text(50, 100, "Take what you can, give nothing back! It's a Pirate's Life for me.");
	gfx_text(380, 140, "Savvy?");
}
...
void loseScreen()
{
	...
	gfx_changefont("lucidasanstypewriter-bold-18");
	gfx_text(90, 80, "You are without doubt the worst pirate I've ever heard of.");
	skull();
}
...
void printText()
{
	...
	gfx_changefont("lucidasanstypewriter-bold-24");		// change font for title
