...
int checkZone(int X, int Y)
{
	...
	if ((X >= 100 && X <= 350) && (Y >= 275 && Y <= 375))
	{
		option = 1;
	}
	else if ((X >= 450 && X <= 700) && (Y >= 275 && Y <= 375))
	{
		option = 2;
	}
	else if ((X >= 275 && X <= 525) && (Y >= 450 && Y <= 550))
	{
		option = 3;
	}
	else if ((X >= 100 && X <= 350) && (Y >= 625 && Y <= 725))
	{
		option = 4;
	}
	else if ((X >= 450 && X <= 700) && (Y >= 625 && Y <= 725))
	{
		option = 0;
	}
	else
...
void printMenu()
{
	printBox(100, 275, "Attack Ships", 170, 325);
	printBox(450, 275, "Hunt for Treasure", 500, 325);
	printBox(275, 450, "Drink Rum", 360, 500);
	printBox(100, 625, "Go to the Market", 155, 675);
	printBox(450, 625, "Quit", 555, 675);
}
...
void printBox(int x, int y, char * title, int xt, int yt)
{
	...
	gfx_fill_rectangle(x, y, 250, 100);
	
	// text
	gfx_color(255, 255, 255); //white
	gfx_changefont("lucidasanstypewriter-bold-14");
...
void printTitle()
{
	...
	gfx_text(375, 75, "YoHo!");
	gfx_text(300, 125, "a pirate's life");
...
int checkFour(struct Blocks board[], int length, int currentPosition)
{
	...
	if (board[currentPosition].color == board[currentPosition - 1].color && board[currentPosition].color == board[currentPosition - 10].color && board[currentPosition].color == board[currentPosition + 1].color && board[currentPosition].color == board[currentPosition + 10].color)
	{
		...
		if (board[currentPosition - 1].treasure) treasure += 1;
		...
		if (board[currentPosition - 10].treasure) treasure += 1;
...
int checkTwo(struct Blocks board[], int length, int currentPosition)
{
	...
	else if ((board[currentPosition].color == board[currentPosition + 10].color) && (board[currentPosition].color == board[currentPosition + 20].color))
	{
		...
		if (board[currentPosition + 20].treasure) treasure += 1;
	...
	else if ((board[currentPosition].color == board[currentPosition + 1].color) && (board[currentPosition].color == board[currentPosition + 2].color))
	{
		...
		if (board[currentPosition + 2].treasure) treasure += 1;
	...
	else if ((board[currentPosition].color == board[currentPosition - 1].color) && (board[currentPosition].color == board[currentPosition - 11].color))
	{
		...
		if (board[currentPosition - 11].treasure) treasure += 1;
	...
	else if ((board[currentPosition].color == board[currentPosition - 1].color) && (board[currentPosition].color == board[currentPosition + 9].color))
	{
		...
		if (board[currentPosition + 9].treasure) treasure += 1;
		...
		switch (c) {
			case 'R': // Up
				...
				else if (board[currentPosition - 10].color == 3)
				{
					...
					collectedTreasure += checkFour(board, length, currentPosition);
					collectedTreasure += checkThree(board, length, currentPosition);
					collectedTreasure += checkTwo(board, length, currentPosition);
					nextColor = newColor();
